...
/* /web/static/src/core/debug/debug_menu.js defined in bundle 'web.assets_frontend_lazy' */
...
MEDIAS.forEach((media)=>media.addEventListener("change",debounce(updateSize,100)));Object.assign(ui,{size:getSize(),});Object.defineProperty(ui,"isSmall",{get(){return ui.size<=SIZES.SM;},});Object.defineProperty(env,"isSmall",{get(){return ui.size<=SIZES.SM;},});return ui;},};registry.category("services").add("ui",uiService);return __exports;});;
